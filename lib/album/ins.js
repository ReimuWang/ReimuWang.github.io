      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://reimuwang-album.oss-cn-beijing.aliyuncs.com/min_photos/' + data.link[i];
            var src = 'https://reimuwang-album.oss-cn-beijing.aliyuncs.com/photos/' + data.link[i];
          ...
          ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year">' + data.year + '年<em>' + data.month + '月</em><em>' + data.day + '日</em></h1>\
